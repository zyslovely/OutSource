       ...
       <div style="border-bottom: 1px solid rgb(224, 224, 224); min-height: 64px;">
           ...
           <table style="width:600px">
                <tbody>
                     ...
                     <tr style="font-size: 16px;height: 70px;">
                        <th style="border-bottom: 1px solid rgb(224, 224, 224);color: rgb(123, 123, 123);width: 150px;">${courseScorePercent.name!""}</th>
                        <th style="border-bottom: 1px solid rgb(224, 224, 224);color: rgb(123, 123, 123);width: 246px;">${courseScorePercent.percent!0}%</th>
                        <th style="border-bottom: 1px solid rgb(224, 224, 224);color: rgb(123, 123, 123);">
