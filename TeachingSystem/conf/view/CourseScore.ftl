   ...
   <#include "subNav.ftl"/>
    <div id="CourseScoreDiv" data_percentType=${percentTypeId!0} data_stage="${stage!0}" data_id="${courseId!0}" style="width: 75%; height: 105px; margin-left: auto; margin-top: 20px;">
       ...
       <table style="width:500px" cellspacing="0">
            ...
            <tbody>
                 <#list studentList as student>
                  ...
                  <th style="border-bottom: 2px solid rgb(224, 224, 224);color: rgb(123, 123, 123);"><input type="text" value="${student.score!0}" style="text-align:center;" class="courseScore_input" data_id="${student.userId!0}"/></th>
                  </tr>
                 </#list>
       ...
       <div style="float: left; width: 200px; margin: 20px auto auto 150px;">
           <a id="courseScore_save" style="background: url('/img/teachCreate/button_edit.png') no-repeat scroll 0px 0px transparent; margin-left: 20px; height: 59px; display: block; text-align: center; color: white; font-size: 20px; line-height: 55px;" href="javascript:void(0);;">确定保存</a>
     </div>
   </div>
</body>
</html>
